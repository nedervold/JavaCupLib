...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Sun Jul 20 18:03:55 PDT 2014
  */
	  ...
	  if (nt == null)
          ...
          else
	    {
	      ...
	      emit.set_start_production(
		     new production(NonTerminalFactory.START_nt, rhs_parts, rhs_pos));
	      new_rhs();
	    }
 ...
 ErrorManager.getManager().emit_error("Syntax Error"); 
	  ...
	  if (lhs_nt != null) 
              ...
              if (start_nt == null)
		{
		  ...
		  if ((sym!=null) && (sym instanceof terminal)) {
		    emit.set_start_production(
		      new production(NonTerminalFactory.START_nt, rhs_parts, 
