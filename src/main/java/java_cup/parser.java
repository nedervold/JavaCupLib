...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Mon Jul 21 11:33:17 PDT 2014
  */
...
// TUM CHANGES
	  ...
	  if (nt == null)
          ...
          else
	    {
	      ...
	      emit.set_start_production(
		     ProductionFactory.createProduction(NonTerminalFactory.START_nt, rhs_parts, rhs_pos));
	      new_rhs();
	    }
 ...
 ErrorManagerAccess.getManager().emit_error("Syntax Error"); 
	  ...
	  if (lhs_nt != null) 
		...
		p = ProductionFactory.createProduction(lhs_nt, rhs_parts, rhs_pos,
              ...
              if (start_nt == null)
		{
		  ...
		  if ((sym!=null) && (sym instanceof terminal)) {
		    emit.set_start_production(
		      ProductionFactory.createProduction(NonTerminalFactory.START_nt, rhs_parts, 
	  ...
	  if (lhs_nt != null) 
	    {
	      /* build the production */
	      production p = ProductionFactory.createProduction(lhs_nt, rhs_parts, rhs_pos);
