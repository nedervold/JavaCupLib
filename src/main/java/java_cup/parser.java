...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Mon Jul 21 08:48:11 PDT 2014
  */
...
// TUM CHANGES
	  ...
	  if (nt == null)
          ...
          else
	    {
	      ...
	      emit.set_start_production(
		     production.createProduction(NonTerminalFactory.START_nt, rhs_parts, rhs_pos));
	      new_rhs();
	    }
 ...
 ErrorManager.getManager().emit_error("Syntax Error"); 
	  ...
	  if (lhs_nt != null) 
		...
		p = production.createProduction(lhs_nt, rhs_parts, rhs_pos,
              ...
              if (start_nt == null)
		{
		  ...
		  if ((sym!=null) && (sym instanceof terminal)) {
		    emit.set_start_production(
		      production.createProduction(NonTerminalFactory.START_nt, rhs_parts, 
	  ...
	  if (lhs_nt != null) 
	    {
	      /* build the production */
	      production p = production.createProduction(lhs_nt, rhs_parts, rhs_pos);
