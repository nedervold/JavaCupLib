...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Mon Jul 21 12:49:02 PDT 2014
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		RESULT = start_val;
          ...
          symbols.put("error", new symbol_part(TerminalFactory.error));

          /* declare start non terminal */
          non_terms.put("$START", NonTerminalFactory.START_nt);
	  ...
	  if (nt == null)
          ...
          else
	    {
	      ...
	      add_rhs_part(new symbol_part(TerminalFactory.EOF));
	      if (!emit.xmlactions()) add_rhs_part(new action_part("RESULT = start_val;"));
	      emit.set_start_production(
		     parser.productionFactory.createProduction(NonTerminalFactory.START_nt, rhs_parts, rhs_pos));
	      new_rhs();
	    }
 ...
 ErrorManagerAccess.getManager().emit_error("Syntax Error"); 
	  ...
	  if (lhs_nt != null) 
              ...
              if (start_nt == null)
		{
		  ...
		  if ((sym!=null) && (sym instanceof terminal)) {
		    emit.set_start_production(
		      parser.productionFactory.createProduction(NonTerminalFactory.START_nt, rhs_parts, 
 ...
 multipart_names.push(multipart_name); multipart_name="";
	  ...
	  if (symbols.get(term_id) != null)
		...
		multipart_name = "Object";
	      ...
	      symbols.put(term_id, 
	        new symbol_part(TerminalFactory.createTerminal(term_id, multipart_name)));
	    }
	  ...
	  if (symbols.get(non_term_id) != null)
		...
		NonTerminalFactory.createNonTerminal(non_term_id, multipart_name);
