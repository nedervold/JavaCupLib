...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Tue Jul 22 10:47:19 PDT 2014
  */
  ...
  public void report_fatal_error(
    ...
    Object   info)
    {
      ...
      if (info instanceof Symbol){
          errorManager.parserFatalError(message,(Symbol)info);
      } else {
          errorManager.parserFatalError(message, cur_token);
      }
      System.exit(1);
    }
    ...
    {
      if (info instanceof Symbol){
         errorManager.parserError(message,(Symbol)info);
      } else {
         errorManager.parserError(message,cur_token);
      }
    }
...
// TUM CHANGES
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
	  ...
	  if (emit.action_code() != null)
	    parser.errorManager.parserWarning("Redundant action code (skipping)");
	  ...
	  if (emit.parser_code()!=null)
	    parser.errorManager.parserWarning("Redundant parser code (skipping)");
	  else /* save the user included code string */
	  ...
	  if (emit.init_code()!=null)
	    parser.errorManager.parserWarning("Redundant init code (skipping)");
	  ...
	  if (emit.scan_code()!=null)
	    parser.errorManager.parserWarning("Redundant scan code (skipping)");
	  else /* save the user code */
	  ...
	  if (symbols.get(sym) == null)
	    {
	      /* issue a message */
	      parser.errorManager.parserError("Terminal \"" + sym +
	  ...
	  if (nt == null)
	    {
	    parser.errorManager.parserError( "Start non terminal \"" + start_name +
	  		         "\" has not been declared");
	    }
          else
	    {
	  ...
	  if (lhs_nt == null)
	    {
	      if (!parser.errorManager.areErrors())
	      parser.errorManager.parserWarning("LHS non terminal \"" + lhs_id +
			       "\" has not been declared");
	    }
	  ...
	  new_rhs();
		...
		String lhs_id = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
          ...
          case 60: // NT$12 ::= 
            {
              Object RESULT =null;
 parser.errorManager.parserError("Syntax Error"); 
	  ...
	  if (symb == null)
	    {
	      if (!parser.errorManager.areErrors())
	        parser.errorManager.parserError("java_cup.runtime.Symbol \"" + symid +
			       "\" has not been declared");
	    }
	  else
	    {
 ...
 multipart_names.push(multipart_name); multipart_name="";
	  ...
	  if (symbols.get(term_id) != null)
	    {
	      /* issue a message */
	      parser.errorManager.parserError("java_cup.runtime.Symbol \"" + term_id +
	  ...
	  if (symbols.get(non_term_id) != null)
	    {
	      /* issue a message */
	      parser.errorManager.parserError( "java_cup.runtime.Symbol \"" + non_term_id +
			                      "\" has already been declared");
	    }
	  else
	    {
		...
		parser.errorManager.parserError("Illegal use of reserved word");
		RESULT="ILLEGAL";
