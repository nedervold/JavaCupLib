...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Wed Jul 16 08:57:35 PDT 2014
  */
...
// TUM CHANGES
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
	  ...
	  emit.setPackage_name(multipart_name);
	  ...
	  emit.getImport_list().push(multipart_name);
	  ...
	  if (nt == null)
          ...
          else
	    {
	      ...
	      if (!emit.is_xmlactions()) add_rhs_part(new action_part("RESULT = start_val;"));
	      emit.setStart_production(
