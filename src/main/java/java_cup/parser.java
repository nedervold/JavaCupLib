...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Mon Jul 21 14:23:31 PDT 2014
  */
  ...
  public void report_fatal_error(
    ...
    public void report_error(String message, Object info)
    {
      if (info instanceof Symbol)
         errorManager.emit_error(message,(Symbol)info);
      else
         errorManager.emit_error(message,cur_token);
    }
...
// TUM CHANGES
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
	  ...
	  if (emit.action_code() != null)
	    parser.errorManager.emit_warning("Redundant action code (skipping)");
	  ...
	  if (emit.parser_code()!=null)
	    parser.errorManager.emit_warning("Redundant parser code (skipping)");
	  else /* save the user included code string */
	  ...
	  if (emit.init_code()!=null)
	    parser.errorManager.emit_warning("Redundant init code (skipping)");
	  ...
	  if (emit.scan_code()!=null)
	    parser.errorManager.emit_warning("Redundant scan code (skipping)");
	  else /* save the user code */
	  ...
	  if (symbols.get(sym) == null)
	    {
	      /* issue a message */
	      parser.errorManager.emit_error("Terminal \"" + sym + 
	  ...
	  if (nt == null)
	    {
	    parser.errorManager.emit_error( "Start non terminal \"" + start_name + 
	  		         "\" has not been declared");
	    }
          else
	    {
	  ...
	  if (lhs_nt == null)
	    {
	      if (parser.errorManager.getErrorCount() == 0)
	      parser.errorManager.emit_warning("LHS non terminal \"" + lhs_id + 
			       "\" has not been declared");
	    }
	  ...
	  new_rhs();
		...
		String lhs_id = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
          ...
          case 60: // NT$12 ::= 
            {
              Object RESULT =null;
 parser.errorManager.emit_error("Syntax Error"); 
	  ...
	  if (symb == null)
	    {
	      if (parser.errorManager.getErrorCount() == 0)
	        parser.errorManager.emit_error("java_cup.runtime.Symbol \"" + symid + 
			       "\" has not been declared");
	    }
	  else
	    {
 ...
 multipart_names.push(multipart_name); multipart_name="";
	  ...
	  if (symbols.get(term_id) != null)
	    {
	      /* issue a message */
	      parser.errorManager.emit_error("java_cup.runtime.Symbol \"" + term_id + 
	  ...
	  if (symbols.get(non_term_id) != null)
	    {
	      /* issue a message */
	      parser.errorManager.emit_error( "java_cup.runtime.Symbol \"" + non_term_id + 
			                      "\" has already been declared");
	    }
	  else
	    {
		...
		parser.errorManager.emit_error("Illegal use of reserved word");
		RESULT="ILLEGAL";
