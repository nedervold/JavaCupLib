...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Tue Jul 15 22:21:11 PDT 2014
  */
...
// TUM CHANGES
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
	  ...
	  emit.instance().setPackage_name(multipart_name);
	  ...
	  emit.instance().getImport_list().push(multipart_name);
	  ...
	  if (emit.instance().getAction_code() != null)
	    ErrorManager.getManager().emit_warning("Redundant action code (skipping)");
	  else /* save the user included code string */
	    emit.instance().setAction_code(user_code);
	  ...
	  if (emit.instance().getParser_code()!=null)
	    ErrorManager.getManager().emit_warning("Redundant parser code (skipping)");
	  else /* save the user included code string */
	    emit.instance().setParser_code(user_code);
	  ...
	  if (emit.instance().getInit_code()!=null)
	    ErrorManager.getManager().emit_warning("Redundant init code (skipping)");
	  else /* save the user code */
	    emit.instance().setInit_code(user_code);
	  ...
	  if (emit.instance().getScan_code()!=null)
	    ErrorManager.getManager().emit_warning("Redundant scan code (skipping)");
	  else /* save the user code */
	    emit.instance().setScan_code(user_code);
	  ...
	  if (nt == null)
          ...
          else
	    {
	      ...
	      if (!emit.instance().is_xmlactions()) add_rhs_part(new action_part("RESULT = start_val;"));
	      emit.instance().setStart_production(
