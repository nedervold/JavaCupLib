...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Tue Jul 15 22:47:36 PDT 2014
  */
...
// TUM CHANGES
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
	  ...
	  EmitterAccess.instance().setPackage_name(multipart_name);
	  ...
	  EmitterAccess.instance().getImport_list().push(multipart_name);
	  ...
	  if (EmitterAccess.instance().getAction_code() != null)
	    ErrorManager.getManager().emit_warning("Redundant action code (skipping)");
	  else /* save the user included code string */
	    EmitterAccess.instance().setAction_code(user_code);
	  ...
	  if (EmitterAccess.instance().getParser_code()!=null)
	    ErrorManager.getManager().emit_warning("Redundant parser code (skipping)");
	  else /* save the user included code string */
	    EmitterAccess.instance().setParser_code(user_code);
	  ...
	  if (EmitterAccess.instance().getInit_code()!=null)
	    ErrorManager.getManager().emit_warning("Redundant init code (skipping)");
	  else /* save the user code */
	    EmitterAccess.instance().setInit_code(user_code);
	  ...
	  if (EmitterAccess.instance().getScan_code()!=null)
	    ErrorManager.getManager().emit_warning("Redundant scan code (skipping)");
	  else /* save the user code */
	    EmitterAccess.instance().setScan_code(user_code);
	  ...
	  if (nt == null)
          ...
          else
	    {
	      ...
	      if (!EmitterAccess.instance().is_xmlactions()) add_rhs_part(new action_part("RESULT = start_val;"));
	      EmitterAccess.instance().setStart_production(
