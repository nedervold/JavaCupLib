...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Tue Jul 15 15:19:33 PDT 2014
  */
...
// TUM CHANGES
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
	  ...
	  emit.instance().package_name = multipart_name;
	  ...
	  emit.instance().import_list.push(multipart_name);
	  ...
	  if (emit.instance().parser_code!=null)
	    ErrorManager.getManager().emit_warning("Redundant parser code (skipping)");
	  else /* save the user included code string */
	    emit.instance().parser_code = user_code;
	  ...
	  if (nt == null)
          ...
          else
	    {
	      ...
	      if (!emit.instance()._xmlactions) add_rhs_part(new action_part("RESULT = start_val;"));
	      emit.instance().start_production = 
