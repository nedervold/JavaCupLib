...
public class terminal_set {
	...
	public terminal_set(TerminalFactory terminalFactory) {
	...
	public terminal_set(terminal_set other) throws internal_error {
		...
		terminalFactory = other.terminalFactory;
	}
	...
	public final terminal_set EMPTY() {
		return new terminal_set(terminalFactory);
	}
