...
public class action_production extends production {
	 ...
	 */
	protected action_production(IErrorManager errorManager, TerminalFactory terminalFactory, NonTerminalFactory nonTerminalFactory, ProductionFactory productionFactory, Emitter emit, production base, non_terminal lhs_sym,
			production_part rhs_parts[], int rhs_len, String action_str,
			int indexOfIntermediateResult) throws internal_error {
		super(errorManager, terminalFactory, nonTerminalFactory, productionFactory, emit, lhs_sym, rhs_parts, rhs_len, action_str);
